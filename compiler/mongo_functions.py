...
def compiler_v3(s, t, r, arr):
    ...
    if arr[1] == "locations":
        ...
        if len(arr) == 3:
            ...
            agent_info = f"""<div class="registered-agent"><ul id="{agent['id']}" class="agent-container">"""
            agent_info += f"""<li class="carriername">Carrier:&nbsp;<a href="/telecom-agents/search/carriername/{agent['carriername']}">{agent['carriername'] if agent['carriername'] else ""}</a></li>"""
            agent_info += f"""<li class="businessname">Business Name:&nbsp;<a href="/telecom-agents/search/carriername/{agent['businessname']}">{agent['businessname'] if agent['businessname'] else ""}</a></li>"""
            agent_info += f"""<li class="holdingcompany">Holding Company:&nbsp;<a href="/telecom-agents/search/carriername/{agent['holdingcompany']}">{agent['holdingcompany'] if agent['holdingcompany'] else ""}</a></li>"""
            ...
            agent_info += f"""<li class="othertradenames1"><a href="/telecom-agents/search/carriername/{agent['othertradename1']}">{agent['othertradename1']}</a></li>""" if agent['othertradename1'] else ""
            agent_info += f"""<li class="othertradenames2"><a href="/telecom-agents/search/carriername/{agent['othertradename2']}">{agent['othertradename2']}</a></li>""" if agent['othertradename2'] else ""
            agent_info += f"""<li class="othertradenames3"><a href="/telecom-agents/search/carriername/{agent['othertradename3']}">{agent['othertradename3']}</a></li>""" if agent['othertradename3'] else ""
            agent_info += f"""<li class="othertradenames4"><a href="/telecom-agents/search/carriername/{agent['othertradename4']}">{agent['othertradename4']}</a></li>""" if agent['othertradename4'] else ""
            ...
            agent_info += f"""<li class="dcagent1">Agent:&nbsp;<a href="/telecom-agents/search/carriername/{agent['dcagent1']}">{agent['dcagent1']}</a></li>""" if agent['dcagent1'] else ""
            agent_info += f"""<li class="dcagent2">Agent Two:&nbsp;<a href="/telecom-agents/search/carriername/{agent['dcagent2']}">{agent['dcagent2']}</a></li>""" if agent['dcagent2'] else ""
            ...
            agent_info += f"""<li class="alternateagent1">Alt Agent:&nbsp;<a href="/telecom-agents/search/carriername/{agent['alternateagent1']}">{agent['alternateagent1']}</a></li>""" if agent['alternateagent1'] else ""
            agent_info += f"""<li class="alternateagent2">Alt Agent:&nbsp;<a href="/telecom-agents/search/carriername/{agent['alternateagent2']}">{agent['alternateagent2']}</a></li>""" if agent['alternateagent2'] else ""
            ...
            for i in coll_te.aggregate([{"$match": {"$or" : [{"carriername": query},{"businessname": query},{"holdingcompany": query},{"othertradename1": query},{"othertradename2": query},{"othertradename3": query},{"othertradename4": query},{"dcagent1": query},{"dcagent2": query},{"alternateagent1": query},{"alternateagent2": query}]}},{"$sort": { k: 1 }}]):
                agents_info += f"""<ul id="{i['id']}" class="agent-container">"""
                agents_info += f"""<li class="carriername">Carrier:&nbsp;<a href="/telecom-agents/search/carriername/{i['carriername']}">{i['carriername'] if i['carriername'] else ""}</a></li>"""
                agents_info += f"""<li class="businessname">Business Name:&nbsp;<a href="/telecom-agents/search/carriername/{i['businessname']}">{i['businessname'] if i['businessname'] else ""}</a></li>"""
                agents_info += f"""<li class="holdingcompany">Holding Company:&nbsp;<a href="/telecom-agents/search/carriername/{i['holdingcompany']}">{i['holdingcompany'] if i['holdingcompany'] else ""}</a></li>"""
                ...
                agents_info += f"""<li class="othertradenames1"><a href="/telecom-agents/search/carriername/{i['othertradename1']}">{i['othertradename1']}</a></li>""" if i['othertradename1'] else ""
                agents_info += f"""<li class="othertradenames2"><a href="/telecom-agents/search/carriername/{i['othertradename2']}">{i['othertradename2']}</a></li>""" if i['othertradename2'] else ""
                agents_info += f"""<li class="othertradenames3"><a href="/telecom-agents/search/carriername/{i['othertradename3']}">{i['othertradename3']}</a></li>""" if i['othertradename3'] else ""
                agents_info += f"""<li class="othertradenames4"><a href="/telecom-agents/search/carriername/{i['othertradename4']}">{i['othertradename4']}</a></li>""" if i['othertradename4'] else ""
                agents_info += f"""</ul></li>""" if i['othertradename1'] else ""
                agents_info += f"""<li class="dcagent1">Agent:&nbsp;<a href="/telecom-agents/search/carriername/{i['dcagent1']}">{i['dcagent1']}</a></li>""" if i['dcagent1'] else ""
                agents_info += f"""<li class="dcagent2">Agent Two:&nbsp;<a href="/telecom-agents/search/carriername/{i['dcagent2']}">{i['dcagent2']}</a></li>""" if i['dcagent2'] else ""
                agents_info += f"""<li class="alternateagent1">Alt Agent:&nbsp;<a href="/telecom-agents/search/carriername/{i['alternateagent1']}">{i['alternateagent1']}</a></li>""" if i['alternateagent1'] else ""
                agents_info += f"""<li class="alternateagent2">Alt Agent Two:&nbsp;<a href="/telecom-agents/search/carriername/{i['alternateagent2']}">{i['alternateagent2']}</a></li>""" if i['alternateagent2'] else ""
                agents_info += f"""<li class="agent-details"><a href="/registered-agents/{i['id']}"><button>Go to Details</button></a></li>"""
                agents_info += "</ul>"
            agents_info += "</div>"
            comp = re.sub("XXagentsXX", agents_info, comp)
